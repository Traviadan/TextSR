...
class UConvenientSaveGame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSaveGameSignature, UConvenientSaveGame*, SaveObject);
/**
 * 
 */
UCLASS(meta = (DisplayName = "Convenient SaveGame System")) // DisplayName creates prettier Blueprint node
class CONVENIENTSAVESYSTEM_API USaveGameSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
protected:
	...
	//UPROPERTY()
	TObjectPtr<UConvenientSaveGame> CurrentSaveGame;
